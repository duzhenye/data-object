...
trait DataListTrait
{
    ...
    private $internalDataListClasses = [
        'Duzhenye\DataListContext' => 'Duzhenye\DataListContext',
        'Duzhenye\DataListAction' => 'Duzhenye\DataListAction',
        'Duzhenye\DataListFilterByAction' => 'Duzhenye\DataListFilterByAction',
        'Duzhenye\DataListSortByAction' => 'Duzhenye\DataListSortByAction',
        'Duzhenye\DataListSlicePropertiesAction' => 'Duzhenye\DataListSlicePropertiesAction',
        'Duzhenye\DataListSliceAction' => 'Duzhenye\DataListSliceAction',
        'Duzhenye\DataListObject' => 'Duzhenye\DataListObject',
    ];
    ...
    public function sliceProperties(array $properties)
    {
        ...
        $className = get_class($this);
        $list = new $className();
        $class = $this->internalDataListClasses['Duzhenye\DataListObject'];
        ...
        if (is_callable($data)) {
            ...
            foreach ($actions as $actionData) {
                if ($actionData[0] === 'filterBy') {
                    $class = $this->internalDataListClasses['Duzhenye\DataListFilterByAction'];
                    $action = new $class();
                    $action->property = $actionData[1];
                    $action->value = $actionData[2];
                    $action->operator = $actionData[3];
                } elseif ($actionData[0] === 'sortBy') {
                    $class = $this->internalDataListClasses['Duzhenye\DataListSortByAction'];
                    $action = new $class();
                    $action->property = $actionData[1];
                    $action->order = $actionData[2];
                } elseif ($actionData[0] === 'sliceProperties') {
                    $class = $this->internalDataListClasses['Duzhenye\DataListSlicePropertiesAction'];
                    $action = new $class();
                    $action->properties = $actionData[1];
                } elseif ($actionData[0] === 'slice') {
                    $class = $this->internalDataListClasses['Duzhenye\DataListSliceAction'];
                    $action = new $class();
                    $action->offset = $actionData[1];
                    $action->limit = $actionData[2];
                } else {
                    $class = $this->internalDataListClasses['Duzhenye\DataListAction'];
                    $action = new $class();
                }
                $action->name = $actionData[0];
                $actionsList[] = $action;
            }
            $class = $this->internalDataListClasses['Duzhenye\DataListContext'];
            $context = new $class();
